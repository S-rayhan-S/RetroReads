...
export default function Search() {
  return (
    <div class="mx-auto w-screen max-w-screen-md px-16 py-2 "> 
  <form class="relative mx-auto flex w-full max-w-2xl items-center justify-between rounded-md border shadow-lg"> 
    ...
    <input type="name" name="search" class="h-14 w-full rounded-md py-4 pr-40 pl-12 outline-none focus:ring-2" placeholder="Ttile, ISBN, Author, Publisher" />
