        ...
        <div className="flex flex-col items-center justify-between lg:flex-row">
          <div className="max-w-xl text-center lg:max-w-lg lg:pr-5 lg:text-left">
            <h2 className="mb-6 max-w-lg text-3xl leading-snug tracking-tight text-green-600 sm:text-5xl sm:leading-snug">
              ...
              Journey of Old Books
            </h2>
            <p className="text-base text-gray-700">
            Each book we curate is meticulously handpicked, ensuring that only the most extraordinary stories grace our shelves. Whether you yearn for classic literature, historical chronicles, or thought-provoking philosophy, our expansive collection will satisfy your deepest literary desires.
            </p>
            <div className="mt-8 flex flex-col justify-center sm:flex-row sm:items-center sm:space-x-4 lg:justify-start">
              <Link  to='/shop' className="relative mt-4 rounded-lg border-2 border-green-600 bg-green-600 px-6 py-2 font-medium text-white transition hover:translate-y-1">
